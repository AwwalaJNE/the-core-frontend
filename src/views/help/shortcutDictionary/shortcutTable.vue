<template>
  <div>
    <table-master 
      hideColumnKey="shortcut-dictionary"
      :dataTable="dataTable"
  ...
  methods: {
    constructTableData() {
      this.dataTable = [
        {
          shortcut: 'Ctrl + P',
          process: 'All Detail Process',
          description: 'Open print'
        },
        {
          shortcut: 'Ctrl + C',
          process: 'All Process',
        ...
        {
          shortcut: 'Esc',
          process: 'All Dialog Process',
          description: 'Cancel or close a modal/dialog'
        },
        {
          shortcut: 'Ctrl + Enter',
          process: 'All Dialog Process',
