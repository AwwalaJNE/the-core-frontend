...
export default {
    ...
    methods: {
        async getTableData(limit, page) {
            ...
            try {
                const res = await axios.get(
                    `${this.URL.courier_delivery}/${this.listenEmployeeId}/runsheet?n=${this.listenNodeId}&sort_order=desc&limit=${limit}&page=${page}`,
                    this.Helper.header()
                )
        ...
        showData(row) {
            this.$router.push(
                `/delivery/runsheet/${this.listenEmployeeId}/edit/${row.delivery_runsheet_number}`
            )
