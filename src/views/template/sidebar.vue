...
export default {
                    ...
                    children: [
                        {
                            ...
                            meta: {
                                resource_type:
                                    resourceLookup['SALES_TRANSACTION_LIST'].resource_type,
                                resource_code:
                                    resourceLookup['SALES_TRANSACTION_LIST'].resource_code,
                                resource_name:
                                    resourceLookup['SALES_TRANSACTION_LIST'].resource_name,
                            },
                        },
                        {
                            label: 'Cash Register',
                    ...
                    children: [
                        {
                            ...
                            meta: {
                                resource_type:
                                    resourceLookup['TRANSPORT_PACKING_KAYU'].resource_type,
                                resource_code:
                                    resourceLookup['TRANSPORT_PACKING_KAYU'].resource_code,
                                resource_name:
                                    resourceLookup['TRANSPORT_PACKING_KAYU'].resource_name,
                            },
                        },
                        // {
                ...
                },
                {
                    ...
                    children: [
                        ...
                        },
                        {
                            ...
                            meta: {
                                resource_type:
                                    resourceLookup['HANDOVER_RUNSHEET_HISTORY'].resource_type,
                                resource_code:
                                    resourceLookup['HANDOVER_RUNSHEET_HISTORY'].resource_code,
                                resource_name:
                                    resourceLookup['HANDOVER_RUNSHEET_HISTORY'].resource_name,
                            },
                        },
                        {
                            label: 'Deposit COD',
                    ...
                    children: [
                        {
                            ...
                            meta: {
                                resource_type:
                                    resourceLookup['CONNOTE_ADJUSTMENT_CONNOTE_CANCEL']
                                        .resource_type,
                                resource_code:
                                    resourceLookup['CONNOTE_ADJUSTMENT_CONNOTE_CANCEL']
                                        .resource_code,
                        ...
                        },
                        {
                            ...
                            meta: {
                                resource_type:
                                    resourceLookup['CONNOTE_ADJUSTMENT_CONNOTE_FORWARD']
                                        .resource_type,
                                resource_code:
                                    resourceLookup['CONNOTE_ADJUSTMENT_CONNOTE_FORWARD']
                                        .resource_code,
                        ...
                        },
                        {
                            ...
                            meta: {
                                resource_type:
                                    resourceLookup['CONNOTE_ADJUSTMENT_CONNOTE_RETURN']
                                        .resource_type,
                                resource_code:
                                    resourceLookup['CONNOTE_ADJUSTMENT_CONNOTE_RETURN']
                                        .resource_code,
                    ...
                    children: [
                        {
                            ...
                            meta: {
                                resource_type:
                                    resourceLookup['IRREGURALITIES_INVENTORY'].resource_type,
                                resource_code:
                                    resourceLookup['IRREGURALITIES_INVENTORY'].resource_code,
                                resource_name:
                                    resourceLookup['IRREGURALITIES_INVENTORY'].resource_name,
                            },
                        },
                        {
                        ...
                        },
                        {
                            ...
                            meta: {
                                resource_type:
                                    resourceLookup['IRREGURALITIES_FAILED'].resource_type,
                                resource_code:
                                    resourceLookup['IRREGURALITIES_FAILED'].resource_code,
                                resource_name:
                                    resourceLookup['IRREGURALITIES_FAILED'].resource_name,
                            },
                        },
                    ],
                },
                ...
                },
                {
                    ...
                    children: [
                        ...
                        },
                        {
                            ...
                            meta: {
                                resource_type:
                                    resourceLookup['HELPDESK_SURAT_MUATAN'].resource_type,
                                resource_code:
                                    resourceLookup['HELPDESK_SURAT_MUATAN'].resource_code,
                                resource_name:
                                    resourceLookup['HELPDESK_SURAT_MUATAN'].resource_name,
                            },
                        },
                        {
                            label: 'Runsheet',
                ...
                },
                {
                    ...
                    children: [
                        ...
                        },
                        {
                            ...
                            meta: {
                                resource_type:
                                    resourceLookup['SETTING_EXCHANGE_RATE'].resource_type,
                                resource_code:
                                    resourceLookup['SETTING_EXCHANGE_RATE'].resource_code,
                                resource_name:
                                    resourceLookup['SETTING_EXCHANGE_RATE'].resource_name,
                            },
                        },
                        {
                        ...
                        },
                        {
                            ...
                            meta: {
                                resource_type:
                                    resourceLookup['SETTINGS_FACILITY_CODE'].resource_type,
                                resource_code:
                                    resourceLookup['SETTINGS_FACILITY_CODE'].resource_code,
                                resource_name:
                                    resourceLookup['SETTINGS_FACILITY_CODE'].resource_name,
                            },
                        },
                        {
                            label: 'Settings KPI',
                        ...
                        },
                        {
                            ...
                            meta: {
                                resource_type:
                                    resourceLookup['SETTINGS_SURAT_MUATAN'].resource_type,
                                resource_code:
                                    resourceLookup['SETTINGS_SURAT_MUATAN'].resource_code,
                                resource_name:
                                    resourceLookup['SETTINGS_SURAT_MUATAN'].resource_name,
                            },
                        },
                        {
                    ...
                    children: [
                        {
                            ...
                            meta: {
                                resource_type:
                                    resourceLookup['HELP_ERROR_DICTIONARY'].resource_type,
                                resource_code:
                                    resourceLookup['HELP_ERROR_DICTIONARY'].resource_code,
                                resource_name:
                                    resourceLookup['HELP_ERROR_DICTIONARY'].resource_name,
                            },
                        },
                        {
                            ...
                            meta: {
                                resource_type:
                                    resourceLookup['HELP_SHORTCUT_DICTIONARY'].resource_type,
                                resource_code:
                                    resourceLookup['HELP_SHORTCUT_DICTIONARY'].resource_code,
                                resource_name:
                                    resourceLookup['HELP_SHORTCUT_DICTIONARY'].resource_name,
                            },
                        },
                    ],
                },
    ...
    methods: {
        ...
        getMenuWithPermissions() {
            ...
            const userRole = this.listenUserRole[0] || {}
            const { menus, menuRolePermission } = this
            const foundPermission = menuRolePermission.find(
                (permission) => permission.role === userRole?.app_role_name
            )
            const filtered = []
            ...
            menus.forEach((menu) => {
                ...
                if (foundPermission?.type === 'exclusive') {
                    ...
                    const filteredChildren = children.filter((child) => {
                        ...
                        if (
                            permissions.includes('read-airport-prealert') &&
                            child.label === 'Receiving'
                        ) {
                            return false
                        }
