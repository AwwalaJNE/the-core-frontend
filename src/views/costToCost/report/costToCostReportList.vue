            ...
            await axios
                ...
                .then((res) => {
                    ...
                    data.map((item) => {
                        ...
                        item['owner_name'] = item.cost_to_cost.cost_owner[0]
                            ? item.cost_to_cost.cost_owner[0].node_name
                            : null
                        item['payer_name'] = item.cost_to_cost.cost_payer[0]
                            ? item.cost_to_cost.cost_payer[0].node_name
                            : null
        ...
        actionPrintSelected() {
            if (this.selectedRow.length > 0) {
                ...
                this.openNotification(
                    ...
                    'Silakan pilih History terlebih dahulu'
                )
            }
        },
    },
