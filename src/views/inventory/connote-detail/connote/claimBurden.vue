    ...
    <template v-if="claimBurden.status != null">
      <vs-row>
        ...
        <vs-col xs="12" sm="6" lg="6">
          ...
          <template v-else>
            <div style="height: 170px; display: flex; flex-direction: column; align-items: center; justify-content: center; text-align: center;">
    ...
    <template v-else>
      <vs-col xs="12" sm="12" lg="12">
        <div
          v-if="!loading"
          class="custom-card"
          style="height: 200px; display: flex; flex-direction: column; align-items: center; justify-content: center; text-align: center;"
        >
          <img
