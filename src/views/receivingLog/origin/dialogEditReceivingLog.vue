    ...
    >
        ...
        <template v-slot:content>
            <vs-row justify="space-between">
                ...
                <vs-col xs="12" sm="12" lg="12">
                    <template v-if="!loadingStatus && statusTypeArray.length > 0">
                        <selector 
                            name="Status Code" 
                            :rules="''" 
                            formKey="status"
    ...
    methods: {
        ...
        async getDataStatus() {
            ...
            try {
                ...
                if (this.statusTypeArray.length === 0) {
                    this.statusTypeArray = [{ label: null, value: null }];
                }
            } catch (err) {
        ...
        async handleSubmitData(formData) {
            this.loading = true;
            try {
                const res = await axios.post(`${this.URL.receiving_log}/${this.listenReceivingLogId}?n=${this.listenNodeId}`, formData, this.Helper.headerFormData());
