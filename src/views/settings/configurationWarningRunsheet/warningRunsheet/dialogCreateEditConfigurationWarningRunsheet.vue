...
export default {
    ...
    methods: {
        ...
        getDataReference() {
            this.$store.dispatch(
                'SET_CONFIGURATION_WARNING_RUNSHEET_REFERENCE_ArrData',
                this.referenceArray
            )
        },
        getUrlNodeName() {
        ...
        async updateData() {
            await axios
                .put(
                    this.URL.configuration_warning_runsheet +
                ...
                .then((res) => {
                    ...
                    this.openNotification(
                        null,
                        'Update success',
                        'Update Warning Runsheet is success'
                    )
                })
                .catch((err) => {
                    this.loading = false
            ...
            await axios
                ...
                .then((res) => {
                    ...
                    this.openNotification(
                        null,
                        'Create Success',
                        'Create new Warning Runsheet is success'
                    )
                })
                .catch((err) => {
                    this.loading = false
