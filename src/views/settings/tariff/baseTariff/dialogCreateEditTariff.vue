        ...
        async getDataVehicleMode(){
            await axios
                ...
                .then(res => {
                    ...
                    this.openNotification('danger', err.response ? err.response.data.code : '', 'You must have an access role Vehicle Mode list', err)
                })
        },
        async getDataCustomer(){
            await axios
                ...
                .then(res => {
                    ...
                    this.openNotification('danger', err.response ? err.response.data.code : '', 'You must have an access role Customer list', err)
                })
        },
        async updateData(){
            await axios
