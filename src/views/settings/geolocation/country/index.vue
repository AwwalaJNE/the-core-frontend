<template>
    <div>
        ...
        <table-master 
        hideColumnKey="geolocation-country" 
        :dataTable="dataTable" 
        ...
        <dialog-confirm
            title="Remove Geolocation Country"
            :message="`Are you sure you want to remove this geolocation country with id ${this.id}?`"
...
export default {
    ...
    data() {
        return {
            ...
            searchBy: "country id",
            filterDateBy: "create",
            searchPlaceholder: "Search Geolocation ID",
            searchParams: [
                {
    ...
    methods: {
        ...
        actionRemove(val){
            this.id = val.geolocation_country_id;
        ...
        async removeData(){
            await axios
                .delete(
                    this.URL.geolocation_country + `/${this.id}?n=${this.listenNodeId}`,
                    this.Helper.header())
                .then(res => {
