<template>
    <div>
        ...
        <table-master 
        hideColumnKey="geolocation-city" 
        :dataTable="dataTable" 
...
export default {
    ...
    data() {
        return {
            ...
            searchBy: "city id",
            filterDateBy: "create",
            searchPlaceholder: "Search City ID",
            searchParams: [
                {
                    label: "City ID",
                    value: "city id",
            ...
            await axios
                ...
                .then(res => {
                    ...
                    if(res.data.data.length > 0) {
                        ...
                        // this.openNotification('warn', null, 'City data is empty!', ' Please create a new city data')
                    }
                    
                    this.loading = false
                }).catch(err => {
                    this.loading = false
                    this.openNotification('danger', err.response ? err.response.data.code : '', 'Failed to populate city list', err)
                })
        },
        actionUpdate(val){
