...
export default {
    ...
    methods: {
        formData(form) {
            this.form = form
            if (
                this.geolocation_subdistrict_id !== undefined &&
            ...
            await axios
                ...
                .then((res) => {
                    if (res.data.data.length > 0) {
                        ...
                        this.$store.dispatch(
                            'SET_GEOLOCATION_SUBDISTRICT_GEOLOCATION_DISTRICT_ID_ArrData',
            ...
            await axios
                .put(
                    this.URL.geolocation_subdistrict +
                        `/${this.geolocation_subdistrict_id}?n=${this.listenNodeId}`,
            ...
            await axios
                ...
                .then((res) => {
                    ...
                    this.openNotification(
                        null,
                        'Create success',
                        'Create new subdistrict is success'
                    )
                })
                .catch((err) => {
                    this.loading = false
