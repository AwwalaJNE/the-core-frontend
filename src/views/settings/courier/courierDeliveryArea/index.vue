        ...
        async getTableData(limit, page, q, from, to, searchBy) {
            ...
            try {
                const res = await axios.get(
                    `${this.URL.courier_delivery_area}?n=${this.listenNodeId}&sort_order=desc&limit=${limit}&page=${page}&s=${query}&start_date=${startDate}&end_date=${endDate}&search_by=${searchBy}&filter_date_by=${this.filterDateBy}&area_type=${this.filterAreaTypeBy}`,
                    this.Helper.header()
                )
        ...
        async removeData() {
            ...
            try {
                const res = await axios.delete(
                    `${this.URL.courier_delivery_area}/${this.selected_id}?n=${this.listenNodeId}`,
                    this.Helper.header()
                )
                this.openNotification(
                    'success',
                    null,
                    'Success',
                    res?.data?.message || 'Remove Courier Delivery Area success'
                )
            } catch (err) {
                this.openNotification(
                    'danger',
