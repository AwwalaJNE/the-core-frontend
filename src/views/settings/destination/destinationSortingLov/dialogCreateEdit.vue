...
export default {
    ...
    methods: {
        async getDataDetail(val) {
            ...
            this.$store.dispatch(
                'SET_DESTINATION_SORTING_LOV_REFERENCE_VALUE_ValueData',
                val.reference_value
            )
            this.$store.dispatch(
                'SET_DESTINATION_SORTING_LOV_REFERENCE_VALUE_ArrData',
        ...
        async handleSubmitData() {
            ...
            try {
                const res = this.id
                    ? await axios.put(
                          `${this.URL.destination_sorting_lov}/${this.id}?n=${this.listenNodeId}`,
                          this.form,
                          this.Helper.header()
                      )
                    : await axios.post(
                          `${this.URL.destination_sorting_lov}?n=${this.listenNodeId}`,
                          this.form,
                          this.Helper.header()
                      )
