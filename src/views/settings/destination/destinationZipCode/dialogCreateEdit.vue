...
export default {
    ...
    methods: {
        async getDataDetail(val) {
            ...
            this.$store.dispatch(
                'SET_DESTINATION_ZIP_CODE_REFERENCE_VALUE_ValueData',
                val.reference_value
            )
            this.$store.dispatch(
                'SET_DESTINATION_ZIP_CODE_REFERENCE_VALUE_ArrData',
        ...
        async handleSubmitData() {
            ...
            try {
                const res = this.id
                    ? await axios.put(
                          `${this.URL.destination_zip_code}/${this.id}?n=${this.listenNodeId}`,
                          this.form,
                          this.Helper.header()
                      )
                    : await axios.post(
                          `${this.URL.destination_zip_code}?n=${this.listenNodeId}`,
                          this.form,
                          this.Helper.header()
                      )
