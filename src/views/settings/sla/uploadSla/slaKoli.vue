    ...
    <div>
        <div class="box view">
            <template v-if="dataTable.length == 0">
                <p style="text-align: start;"><b>SLA Koli</b></p>
            </template>
...
export default {
    ...
    methods: {
        ...
        async handleUpload() {
            ...
            await axios
                .post(this.URL.sla_koli + `/bulk?n=${this.listenNodeId}`,
                    formData,
