    ...
    <div>
        <div class="box view">
            <template v-if="dataTable.length == 0">
                <p style="text-align: start;"><b>SLA Node to Node B</b></p>
            </template>
...
export default {
    ...
    data() {
        return {
            ...
            typed: [],
            inputType: [],
            selectedInputType: "SLA_Node_to_Node_B",
            InputObject: {},
            InputKeys: [],
            datacolumn: [],
            dataTable: [],
    ...
    methods: {
        ...
        async handleUpload() {
            ...
            await axios
                .post(this.URL.sla_node_to_node_b + `/bulk?n=${this.listenNodeId}`,
                    formData,
        ...
        handleDownload(){
            ...
            var ws_name = "SLA Node to Node B";
            /* make worksheet */
            var ws_data = [];
