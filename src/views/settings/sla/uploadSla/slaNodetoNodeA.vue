    ...
    <div>
        <div class="box view">
            <template v-if="dataTable.length == 0">
                <p style="text-align: start;"><b>SLA Node to Node A</b></p>
            </template>
            ...
            <template v-if="dataTable.length > 0">
                    ...
                    <table-master 
                    hideColumnKey="upload-sla-node-to-node-a" 
                    :dataTable="dataTable" 
...
export default {
    ...
    data() {
        return {
            ...
            typed: [],
            inputType: [],
            selectedInputType: "SLA_Node_to_Node_A",
            InputObject: {},
            InputKeys: [],
            datacolumn: [],
            dataTable: [],
    ...
    methods: {
        ...
        async handleUpload() {
            ...
            await axios
                .post(this.URL.sla_node_to_node_a + `/bulk?n=${this.listenNodeId}`,
                    formData,
        ...
        handleDownload(){
            ...
            var ws_name = "SLA Node to Node A";
            /* make worksheet */
            var ws_data = [];
