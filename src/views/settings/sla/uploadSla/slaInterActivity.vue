    ...
    <div>
        <div class="box view">
            <template v-if="dataTable.length == 0">
                <p style="text-align: start;"><b>SLA Inter Activity</b></p>
            </template>
...
export default {
    ...
    data() {
        return {
            ...
            typed: [],
            inputType: [],
            selectedInputType: "SLA_Inter_Activity",
            InputObject: {},
            InputKeys: [],
            datacolumn: [],
            dataTable: [],
    ...
    methods: {
        ...
        async handleUpload() {
            ...
            await axios
                .post(this.URL.sla_inter_activity + `/bulk?n=${this.listenNodeId}`,
                    formData,
        ...
        handleDownload(){
            ...
            var ws_name = "SLA Inter Activity";
            /* make worksheet */
            var ws_data = [];
