<template>
    <div>
        ...
        <table-master 
            hideColumnKey="sla-node-to-node-b" 
            :dataTable="dataTable" 
...
export default {
    ...
    methods: {
        async getTableData(limit,page,q,from,to, searchBy, filterStatusBy) {
            ...
            await axios
                .get(this.URL.sla_node_to_node_b + 
        ...
        closedialogSla() {
            this.$store.dispatch("SET_SLA_NODE_TO_NODE_B_SLA_ID_visible", false)
        ...
        async removeData(){
            await axios
                .delete(
                    this.URL.sla_node_to_node_b + `/${this.id}?n=${this.listenNodeId}`,
                    this.Helper.header())
                .then(res => {
