...
export default {
    ...
    methods: {
        async getTableData(limit, page, q, from, to) {
            ...
            await axios
                .get(
                    this.URL.audit_invalid_log +
                        `?n=${this.listenNodeId}&type=${this.type}&sort_order=desc&limit=${limit}&page=${page}&s=${query}&start_date=${startDate}&end_date=${endDate}&search_by=${this.searchBy}&filter_date_by=${this.filterDateBy}`,
                    this.Helper.header()
                )
                .then((res) => {
