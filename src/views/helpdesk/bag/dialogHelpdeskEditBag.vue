        ...
        async getBag() {
            ...
            try {
                let res = await axios.get(
                    `${this.URL.bag}/${this.listenBagNumber}?n=${this.listenNodeId}`,
                    this.Helper.header()
                )
        ...
        async updateLocation() {
            ...
            try {
                const res = await axios.patch(
                    `${this.URL.bag}/${this.listenBagNumber}/move?n=${this.listenNodeId}&node_location_id=${this.formHelpdeskMoveBag}`,
                    {},
                    this.Helper.header()
                )
        ...
        async updateBag() {
            ...
            try {
                const res = await axios.put(
                    `${this.URL.bag}/${this.listenBagNumber}?n=${this.listenNodeId}`,
                    JSON.stringify(this.formHelpdeskEditBag),
                    this.Helper.header()
                )
                this.openNotification('success', null, 'Success', res?.data?.message)
            } catch (err) {
