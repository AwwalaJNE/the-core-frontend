    ...
    methods: {
        async getBagActivity() {
            ...
            try {
                ...
                const response = await axios.get(`${this.URL.bag}/${encodeURIComponent(this.bag_number)}/history?n=${this.listenNodeId}&sort_order=desc&limit=${limit}&page=${page}`, this.Helper.header());
