            ...
            <vs-row class="mb-4" align="center">
                <vs-col w="10">
                    <vs-input
                        ...
                        block
                        :data-testid="`search-manifest-number`"
                        @keyup.enter="handleSearch"
                    />
                </vs-col>
                <vs-col w="2">
                    <vs-button block @click="handleSearch" :data-testid="`search-button`">
        ...
        async getTableData(limit, page, q) {
            ...
            try {
                const res = await axios.get(
                    `${this.URL.sm_stock}?n=${this.listenNodeId}&vehicle_mode=${moda}&sort_order=desc&limit=${this.pagination.limit}&page=${this.pagination.page}&s=${this.tempSearch}&search_by=manifest_number&node_origin=${this.listenCurrentNode.branch_code}&is_active=1`,
                    this.Helper.header()
                )
