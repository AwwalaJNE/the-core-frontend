    ...
    <div :class="['card', { active: listenIsActive }]">
        ...
        <vs-row justify="space-between" align="center">
            <vs-col w="6" align="left">
                ...
                <span v-if="!listenData.pic_employee_id" class="text">{{
                    formatDateTimeId(listenData.flight_schedule)
                }}</span>
            </vs-col>
            <vs-col w="6" align="right">
                <span v-if="listenData.status_flight" class="badge">{{
                    listenData.status_flight
                }}</span>
            </vs-col>
        </vs-row>
                ...
                <template>
                    <vs-row>
                        <vs-row v-if="listenData.flight_schedule">
                            <vs-col align="center">
                                <img :src="plane" alt="Plane" style="width: 10%" />
                            </vs-col>
                        </vs-row>

                        <vs-row
                            v-if="
                                listenData.origin_vehicle_tlc || listenData.destination_vehicle_tlc
                            "
                        >
                            <vs-col w="4">
                            ...
                            <vs-col w="4">
                                <h1 class="text-subheader">
                                    {{ listenData.destination_vehicle_tlc }}
                                </h1>
                            </vs-col>
                        </vs-row>
                        ...
                        <vs-row>
                            <vs-col align="center">
                                <span class="badge-2">{{
                                    listenData.flight_number || listenData.pic_employee_id
                                }}</span>
                            </vs-col>
                        </vs-row>
                    </vs-row>
