export default {
    ...
    SET_USER_IS_LOGIN_ENABLE_ValueData(state, payload) {
        state.user.is_login_enable.valueData = payload || false
    },
    ...
    SET_USER_DYNAMICINPUTCOMPONENT_USER_OTHER_APPLICATION_ROLE_ValueData(state, payload) {
        state.user.dynamicinputcomponent_user_other_application_role.valueData = payload
    },
    ...
    SET_SURAT_MUATAN_MANIFEST_PREFIX_value(state, payload) {
        state.surat_muatan.manifest_prefix.value = payload
    },
    SET_SURAT_MUATAN_MANIFEST_PREFIX_ValueData(state, payload) {
        state.surat_muatan.manifest_prefix.valueData = payload
    },
    ...
    SET_IRREGURALITIES_RETURN_DESTINATION_DESTINATION_ONCHANGE_ADDRESS_ArrData(state, payload) {
        state.irreguralities_return_destination.destination_onchange_address.hasOwnProperty(
            'arrData'
        )
    ...
    SET_COST_TO_COST_SETTING_DYNAMICINPUTCOMPONENT_COST_TO_COST_DETAIL_VALUE(state, payload) {
        ...
        state.cost_to_cost_setting.dynamicinputcomponent_cost_to_cost_detail_value.hasOwnProperty(
            'arrData'
        )
    ...
    SET_ACTIVE_BAG_WEIGHT_DYNAMICINPUTCOMPONENT_OTHER_DESTINATION(state, payload) {
        const template =
            state.active_bag_weight.dynamicinputcomponent_other_destination.inputs || []
