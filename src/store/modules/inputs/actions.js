export default {
    ...
    SET_USER_IS_LOGIN_ENABLE_ValueData({ commit }, payload) {
        commit('SET_USER_IS_LOGIN_ENABLE_ValueData', payload)
    },
    ...
    SET_USER_DYNAMICINPUTCOMPONENT_USER_OTHER_APPLICATION_ROLE_ValueData({ commit }, payload) {
        commit('SET_USER_DYNAMICINPUTCOMPONENT_USER_OTHER_APPLICATION_ROLE_ValueData', payload)
    },
    ...
    SET_GEOLOCATION_SUBDISTRICT_GEOLOCATION_SUBDISTRICT_ZONA_WILAYAH_ValueData(
        { commit },
        payload
    ) {
        commit(
    ...
    SET_GEOLOCATION_SUBDISTRICT_GEOLOCATION_SUBDISTRICT_KODE_ROUTING_ValueData(
        { commit },
        payload
    ) {
        commit(
    ...
    SET_NODE_ALTERNATE_ADDRESS_NODE_ALTERNATE_ADDRESS_SUBDISTRICT_ID_ValueData(
        { commit },
        payload
    ) {
        commit(
    ...
    SET_IRREGURALITIES_RETURN_DESTINATION_DESTINATION_ONCHANGE_ADDRESS_isDisabled(
        { commit },
        payload
    ) {
        commit(
    ...
    SET_IRREGURALITIES_RETURN_DESTINATION_DESTINATION_ONCHANGE_ADDRESS_ValueData(
        { commit },
        payload
    ) {
        commit(
    ...
    // type select perlu data array
    SET_IRREGURALITIES_RETURN_DESTINATION_DESTINATION_ONCHANGE_ADDRESS_ArrData(
        { commit },
        payload
    ) {
        commit(
    ...
    SET_IRREGURALITIES_RETURN_DESTINATION_DESTINATION_SUBDISTRICT_ID_isDisabled(
        { commit },
        payload
    ) {
        commit(
    ...
    SET_IRREGURALITIES_RETURN_DESTINATION_DESTINATION_SUBDISTRICT_ID_ValueData(
        { commit },
        payload
    ) {
        commit(
    ...
    SET_HELPDESK_EDIT_CONNOTE_CONNOTE_RECEIVER_ADMINISTRATIVE_ADDRESS({ commit }, payload) {
        commit('SET_HELPDESK_EDIT_CONNOTE_CONNOTE_RECEIVER_ADMINISTRATIVE_ADDRESS', payload)
    },
    SET_HELPDESK_EDIT_CONNOTE_CONNOTE_RECEIVER_ADMINISTRATIVE_ADDRESS_ValueData(
        { commit },
        payload
    ) {
        commit(
    ...
    SET_HELPDESK_EDIT_CONNOTE_AMOUNT_TARIFF({ commit }, payload) {
        commit('SET_HELPDESK_EDIT_CONNOTE_AMOUNT_TARIFF', payload)
    },
    SET_HELPDESK_EDIT_CONNOTE_AMOUNT_TARIFF_ValueData({ commit }, payload) {
        commit('SET_HELPDESK_EDIT_CONNOTE_AMOUNT_TARIFF_ValueData', payload)
    },
    ...
    SET_SURAT_MUATAN_STOCK_VEHICLE_ID_ValueData({ commit }, payload) {
        commit('SET_SURAT_MUATAN_STOCK_VEHICLE_ID_ValueData', payload)
    },
    ...
    SET_SURAT_MUATAN_STOCK_ETA({ commit }, payload) {
        commit('SET_SURAT_MUATAN_STOCK_ETA', payload)
    },
    ...
    SET_SURAT_MUATAN_STOCK_IS_ACTIVE({ commit }, payload) {
        commit('SET_SURAT_MUATAN_STOCK_IS_ACTIVE', payload)
    },
    SET_SURAT_MUATAN_STOCK_IS_ACTIVE_ValueData({ commit }, payload) {
        commit('SET_SURAT_MUATAN_STOCK_IS_ACTIVE_ValueData', payload)
    },
    ...
    SET_SURAT_MUATAN_SCHEDULE_ORIGIN_NAME_visible({ commit }, payload) {
        commit('SET_SURAT_MUATAN_SCHEDULE_ORIGIN_NAME_visible', payload)
    },
    ...
    SET_SURAT_MUATAN_SCHEDULE_ORIGIN_IDENTIFIER_visible({ commit }, payload) {
        commit('SET_SURAT_MUATAN_SCHEDULE_ORIGIN_IDENTIFIER_visible', payload)
    },
    ...
    SET_SURAT_MUATAN_SCHEDULE_ORIGIN_POINT_visible({ commit }, payload) {
        commit('SET_SURAT_MUATAN_SCHEDULE_ORIGIN_POINT_visible', payload)
    },
    ...
    SET_SURAT_MUATAN_SCHEDULE_DESTINATION_NAME_visible({ commit }, payload) {
        commit('SET_SURAT_MUATAN_SCHEDULE_DESTINATION_NAME_visible', payload)
    },
    ...
    SET_SURAT_MUATAN_SCHEDULE_DESTINATION_IDENTIFIER_visible({ commit }, payload) {
        commit('SET_SURAT_MUATAN_SCHEDULE_DESTINATION_IDENTIFIER_visible', payload)
    },
    ...
    SET_SURAT_MUATAN_SCHEDULE_DESTINATION_POINT_visible({ commit }, payload) {
        commit('SET_SURAT_MUATAN_SCHEDULE_DESTINATION_POINT_visible', payload)
    },
