...
// type select perlu data array
  ...
  SET_COST_TO_COST_SETTING_DYNAMICINPUTCOMPONENT_RULES({ commit }, payload) {
    commit('SET_COST_TO_COST_SETTING_DYNAMICINPUTCOMPONENT_RULES', payload)
  },
  SET_COST_TO_COST_SETTING_DYNAMICINPUTCOMPONENT_COST_VALUE({ commit }, payload) {
    commit('SET_COST_TO_COST_SETTING_DYNAMICINPUTCOMPONENT_COST_VALUE', payload)
  },
