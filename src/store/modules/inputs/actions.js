export default {
  ...
  SET_NODE_ALTERNATE_ADDRESS_NODE_ALTERNATE_ADDRESS_ZIP_CODE({ commit }, payload) {
    commit('SET_NODE_ALTERNATE_ADDRESS_NODE_ALTERNATE_ADDRESS_ZIP_CODE', payload)
  },
  SET_NODE_ALTERNATE_ADDRESS_NODE_ALTERNATE_ADDRESS_ZIP_CODE_ValueData({ commit }, payload) {
    commit('SET_NODE_ALTERNATE_ADDRESS_NODE_ALTERNATE_ADDRESS_ZIP_CODE_ValueData', payload)
  },
  ...
  SET_NODE_ALTERNATE_ADDRESS_NODE_ALTERNATE_ADDRESS_DISTRICT_ID({ commit }, payload) {
    commit('SET_NODE_ALTERNATE_ADDRESS_NODE_ALTERNATE_ADDRESS_DISTRICT_ID', payload)
  },
  SET_NODE_ALTERNATE_ADDRESS_NODE_ALTERNATE_ADDRESS_DISTRICT_ID_ValueData({ commit }, payload) {
    commit('SET_NODE_ALTERNATE_ADDRESS_NODE_ALTERNATE_ADDRESS_DISTRICT_ID_ValueData', payload)
  },
    // type select perlu data array
  SET_NODE_ALTERNATE_ADDRESS_NODE_ALTERNATE_ADDRESS_DISTRICT_ID_ArrData({ commit }, payload) {
    commit('SET_NODE_ALTERNATE_ADDRESS_NODE_ALTERNATE_ADDRESS_DISTRICT_ID_ArrData', payload)
  },
    
  SET_NODE_ALTERNATE_ADDRESS_NODE_ALTERNATE_ADDRESS_CITY_ID({ commit }, payload) {
    commit('SET_NODE_ALTERNATE_ADDRESS_NODE_ALTERNATE_ADDRESS_CITY_ID', payload)
  },
  SET_NODE_ALTERNATE_ADDRESS_NODE_ALTERNATE_ADDRESS_CITY_ID_ValueData({ commit }, payload) {
    commit('SET_NODE_ALTERNATE_ADDRESS_NODE_ALTERNATE_ADDRESS_CITY_ID_ValueData', payload)
  },
    // type select perlu data array
  SET_NODE_ALTERNATE_ADDRESS_NODE_ALTERNATE_ADDRESS_CITY_ID_ArrData({ commit }, payload) {
    commit('SET_NODE_ALTERNATE_ADDRESS_NODE_ALTERNATE_ADDRESS_CITY_ID_ArrData', payload)
  },
    
  SET_NODE_ALTERNATE_ADDRESS_NODE_ALTERNATE_ADDRESS_PROVINCE_ID({ commit }, payload) {
    commit('SET_NODE_ALTERNATE_ADDRESS_NODE_ALTERNATE_ADDRESS_PROVINCE_ID', payload)
  },
  SET_NODE_ALTERNATE_ADDRESS_NODE_ALTERNATE_ADDRESS_PROVINCE_ID_ValueData({ commit }, payload) {
    commit('SET_NODE_ALTERNATE_ADDRESS_NODE_ALTERNATE_ADDRESS_PROVINCE_ID_ValueData', payload)
  },
    // type select perlu data array
  SET_NODE_ALTERNATE_ADDRESS_NODE_ALTERNATE_ADDRESS_PROVINCE_ID_ArrData({ commit }, payload) {
    commit('SET_NODE_ALTERNATE_ADDRESS_NODE_ALTERNATE_ADDRESS_PROVINCE_ID_ArrData', payload)
  },
    
  SET_NODE_ALTERNATE_ADDRESS_NODE_ALTERNATE_ADDRESS_TIME_ZONE_ID({ commit }, payload) {
    commit('SET_NODE_ALTERNATE_ADDRESS_NODE_ALTERNATE_ADDRESS_TIME_ZONE_ID', payload)
  },
  SET_NODE_ALTERNATE_ADDRESS_NODE_ALTERNATE_ADDRESS_TIME_ZONE_ID_ValueData({ commit }, payload) {
    commit('SET_NODE_ALTERNATE_ADDRESS_NODE_ALTERNATE_ADDRESS_TIME_ZONE_ID_ValueData', payload)
  },
    // type select perlu data array
  SET_NODE_ALTERNATE_ADDRESS_NODE_ALTERNATE_ADDRESS_TIME_ZONE_ID_ArrData({ commit }, payload) {
    commit('SET_NODE_ALTERNATE_ADDRESS_NODE_ALTERNATE_ADDRESS_TIME_ZONE_ID_ArrData', payload)
  },
    
  SET_NODE_ALTERNATE_ADDRESS_NODE_ALTERNATE_ADDRESS_TARIFF_CODE({ commit }, payload) {
    commit('SET_NODE_ALTERNATE_ADDRESS_NODE_ALTERNATE_ADDRESS_TARIFF_CODE', payload)
  },
  SET_NODE_ALTERNATE_ADDRESS_NODE_ALTERNATE_ADDRESS_TARIFF_CODE_ValueData({ commit }, payload) {
    commit('SET_NODE_ALTERNATE_ADDRESS_NODE_ALTERNATE_ADDRESS_TARIFF_CODE_ValueData', payload)
  },
    // type select perlu data array
  SET_NODE_ALTERNATE_ADDRESS_NODE_ALTERNATE_ADDRESS_TARIFF_CODE_ArrData({ commit }, payload) {
    commit('SET_NODE_ALTERNATE_ADDRESS_NODE_ALTERNATE_ADDRESS_TARIFF_CODE_ArrData', payload)
  },
  ...
  SET_NODE_ALTERNATE_ADDRESS_NODE_ALTERNATE_ADDRESS_ZONE_CODE({ commit }, payload) {
    commit('SET_NODE_ALTERNATE_ADDRESS_NODE_ALTERNATE_ADDRESS_ZONE_CODE', payload)
  },
  SET_NODE_ALTERNATE_ADDRESS_NODE_ALTERNATE_ADDRESS_ZONE_CODE_ValueData({ commit }, payload) {
    commit('SET_NODE_ALTERNATE_ADDRESS_NODE_ALTERNATE_ADDRESS_ZONE_CODE_ValueData', payload)
  },
